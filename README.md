...
Default is `0`, deactivated filter. Setting to 1 enables single-pass
...
### `--peek-guess`
Equivalent to `infer` option in SMRTlink. Sets following options:
...
barcode-free adapters. In contrary, a 1D k-means similar to the original Lloyd
...
Remove all duplicate primer sequences.
