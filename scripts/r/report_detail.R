...
g = ggplot(bind_rows(titration,titration_pass)) +
  ...
  theme_light()
ggsave(paste0("detail_score_vs_yield.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_score_lead.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_signal_increase.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_hq_length_vs_score.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_read_length_vs_score.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_yield_zmw.",output),g,width=25,height=yieldHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_yield_read.",output),g,width=25,height=yieldHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_yield_base.",output),g,width=25,height=yieldHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_hq_length_hist_barcoded_or_not.",output),g,width=25,height=15,dpi=dpi,units="cm")
...
ggsave(paste0("detail_read_length_hist_barcoded_or_not.",output),g,width=25,height=15,dpi=dpi,units="cm")
...
ggsave(paste0("detail_scores_per_adapter.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_num_adapters.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_read_length_hist_group_same_y.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
g = ggplot(x, aes(group = BarcodePair, x = ReadLengths)) +
  ...
  geom_histogram(binwidth = 1000, position="dodge", color="black", fill="gray")+
  theme_light()+ylab("Number of ZMWs")+xlab("Read Length")
ggsave(paste0("detail_read_length_hist_group_free_y.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")

g = ggplot(x, aes(group = BarcodePair, ReadLengths, color = BarcodePair)) +
  coord_cartesian(xlim = c(0, quantile(x$ReadLengths,0.999))) +
  geom_freqpoly(binwidth = 1000)+
  theme_minimal()+ylab("Number of ZMWs")+xlab("Read Length")
ggsave(paste0("detail_read_length_linehist_nogroup.",output),g,width=25,height=15,dpi=dpi,units="cm")
...
ggsave(paste0("detail_hq_length_hist_group_same_y.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
g = ggplot(y, aes(group = BarcodePair, x = HQLength)) +
  ...
  geom_histogram(binwidth = 2000, position="dodge", color="black", fill="gray")+
  theme_light()+ylab("Number of ZMWs")+xlab("HQ Length")
ggsave(paste0("detail_hq_length_hist_group_free_y.",output),g,width=facetWidth,height=facetHeight,dpi=dpi,units="cm")
...
ggsave(paste0("detail_hq_length_linehist_nogroup.",output),g,width=25,height=15,dpi=dpi,units="cm")
